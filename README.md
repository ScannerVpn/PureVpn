...
اسکنر سادهٔ که در دسترس‌بودن سرورهای PureVPN را از پشت DPI/فیلترینگ بررسی می‌کند. لیست سرورها به‌صورت استاتیک همراه پروژه است و برای هر سرور، کشور، پرچم و نوع پروتکل به‌صورت خودکار از روی نام دامنه استخراج می‌شود.
